...
namespace Scanner.Atomship {
    ...
    internal class OldModuleEditor : MonoBehaviour {
        ...
        ////    var h2 = Hexes.RotateAroundZero(hex.hex, hexrot);
    ...
    static class ModelSerializer {
        public static byte[] Serialize(StructureModel model) {
            ...
            foreach (var feature in model.features) {
                ...
                writer.Write((byte)feature.localDirection.radial);
                writer.Write((sbyte)feature.localDirection.longitudinal);
        ...
        public static StructureModel Deserialize(byte[] blob) {
            ...
            for (int i = 0; i < count; i++) {
                ...
                var coords = new Core.H3.H3(new Hex(reader.ReadInt32(), reader.ReadInt32()), reader.ReadInt32());
                var graphicVariant = reader.ReadInt32();
                var directionRad = reader.ReadByte();
                var directionLong = reader.ReadSByte();
                ...
                features.Add(new Feature {
                    ...
                    localDirection = new Core.H3.PrismaticHexDirection((Core.H3.HexDir)directionRad, directionLong),
                    connType = connType,
                });
            }
